                      ...
                      \inference{
                        \uncover<15->{
                          \inference{
                            ...
                            (\mathtt{b} + \mathtt{c})^{\ast}
                          }
                        }
                      }{
                        \mathtt{fold}\ \uncover<16->{\mathtt{inl} \uncover<17->{()}} : (\mathtt{b} + \mathtt{c})^{\ast}
                      }
                    }
                  }{
                    (
...
\begin{frame}
  ...
  Remember: \texttt{inl} is 0, \texttt{inr} is 1.
...
\begin{frame}
  ...
  \only<8>{Statistically analysis of the data to encode, suggests equivalent regular
