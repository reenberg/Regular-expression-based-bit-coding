...
\paragraph{Note.} The sum of the size of the two splits are not exactly the same as
the size of the original file as the XML parser strips any unnecessary extra
whitespace (i.e., multiple spaces between element attributes) and the
\texttt{<!DOCTYPE..>} element was also removed when the meta data file was
generated.
...
\begin{nonfloatingtable}
  ...
  \caption{Results from compressing using GZIP and our bit coding. All sizes are
    in bytes. \textbf{Note} that the the sum of the size of the two splits are
    ...
    when the meta data file was generated.}
