...
\item Splitting the file into its data and meta (xml structure) par \fixme{hvor
    beskrives dette?} and then running gzip on the data and our bit coding on
  the meta.
\end{enumerate}
...
\begin{nonfloatingtable}
  ...
  \begin{tabular}{|l|l|}\hline
    ...
    & \begin{tabular}{|l|c|c|c|} \hline 
      ...
      \textbf{Description} & \textbf{Original size} & \textbf{Size after gzip} &
      \textbf{Size after bit code} \\ \hline

      Original file  & 1069858 & 177541 & 373568 \\ \hline
      Orig split into data & 606046 & 144779 & \\
      Orig split into meta & 457985 & & 94745 \\ \hline
    \end{tabular} \\
    & \\ \hline
  \end{tabular}

  \caption{Results from compressing using gzip and our bit coding. All sizes are
  in bytes. \textbf{Note} that the sum of the two splits size
  are not exactly the same as the size of the original file as the XML parser strips
  any unnecessary extra whitespace (i.e., multiple spaces between element
  attributes) and the \texttt{<!DOCTYPE..>} element was also removed when the meta
...
\begin{nonfloatingtable}
  ...
  \begin{tabular}{|l|l|} \hline
    ...
    1 & DBLP sample file \#1 \\
    & \begin{tabular}{|l|c|c|c|} \hline
    \textbf{Description} & \textbf{Original Size} & \textbf{Compressed size} &
    \textbf{Compression factor} \\ \hline

    Orig file gzip & 1069858 & 177541 & 6.03 \\
    Orig file bit code & 1069858 & 373568 & 2.86 \\
    Splittet file & 1064031 & 239524 & 4.44 \\ \hline
  \end{tabular} \\ 
   & \\ \hline
  \end{tabular}
