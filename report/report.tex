...
\cite{oracle_based_checking_of_untrusted_software}

\section{Automatized Derivation of Regular Expressions from XML Schemas}

\section{$\mu$-Recursion}

\subsection{Normalizing $\mu$-expressions}

\section{Sum balancing using Huffman coding}
