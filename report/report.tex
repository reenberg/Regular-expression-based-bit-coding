...
section \ref{sec:mu_recursion} extends regular expressions with recursion, and shows how to encode parse trees more efficiently;
section \ref{sec:specialize_huffman} shows how to specialise a regular expression to the specific XML-data being compressed;
...
\section{Specializing regular expressions to strings using Huffman trees}
\label{sec:huffman}
