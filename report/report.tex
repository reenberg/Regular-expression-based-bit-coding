...
We expect readers to posses basic knowledge of regular expressions \cite{houl2006}. Also we expect familiarity with inference system and programming language semantics \cite{gu1992, wi1993}. Knowledge of Huffman coding \cite[Section 16.3]{co2001} is necessary to understand Section \ref{sec:convert_huffman}.
...
Theorem 9 in \cite{heli2010} states that $Reg_{\Sigma}^{\mu}$ describes exactly
