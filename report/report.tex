...
\Fref[plain]{chap:convert} shows how to automatically derive a regular expression from a DTD scheme;
\Fref[plain]{chap:mu-recursion} extends regular expressions with recursion, and shows how to encode parse trees efficienctly;
\Fref[plain]{chap:huffman} shows how to specialize a regular expression to the specific XML-data being compressed;
