...
Compression of XML files \cite{FIX ME} has a wide range of applications. On the internet and in database systems XML is an extensively used format for encoding documents and storing data in a machine-readable form. Typically XML files includes a large amount of meta-data
...
Basic knowledge of regular expressions \cite{FIX ME} is assumed. Some experience with inference system and programming language semantics \cite{FIX ME} will be useful.

\section{Organization}

The rest of the paper is organized as follows: In Section FIX ME we ... In Section FIX ME we ... blah blah

This paper marks the conclussion of the DIKU course \emph{Topics in Programming Languages}.

\section{Acknowledgement}

The authors extend their graditude to FIX ME, FIX ME, and FIX ME for insightful comments. Also we would like to thank Lasse Nielsen for providing us the source code for his dynamic parser.
