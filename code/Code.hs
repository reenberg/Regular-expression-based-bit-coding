...
type Env a = Map Var (Regex a)

instance Show Bit where
  show B0 = "0"
  show B1 = "1"

code1 :: (Show a, Eq a) => STree a -> Regex a -> Env a -> Writer [Bit] ()
...
code :: (Show a, Eq a) => Regex a -> STree a -> [Bit]
code e v = execWriter (code1 v e Map.empty)

decode1 :: Eq a => Regex a -> Env a -> Consume Bit (STree a)
